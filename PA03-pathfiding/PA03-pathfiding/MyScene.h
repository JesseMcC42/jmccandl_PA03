...
namespace GMUCS425
{
    ...
    class MyScene
    {
        public:
		  ...
		  virtual bool createLoader();
		  virtual bool createWinner();
		  virtual bool createFailer();

		  virtual int getNumItems() { return this->items;}
		  virtual void setNumItems(int num) { this->items = num; }
